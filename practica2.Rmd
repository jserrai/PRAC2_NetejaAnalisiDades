...
dataset_clean$race_distance <- unlist(lapply(dataset_clean$race_distance, as.numeric))
```
...
Utilitzem una representació gràfica (histograma i boxplot), per a visualitzar els outliers:
